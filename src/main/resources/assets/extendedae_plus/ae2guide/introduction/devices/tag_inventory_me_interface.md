...
For example, `forge:ingots & !forge:ingots/iron` selects tagged ingots other than iron ingots. The blacklist is applied after the whitelist and excludes any matching items. If both expressions are empty, the interface exposes no items.
