...
/** 超级装配矩阵的混合核心方块。 */
public class HybridCoreBlock extends BlockAssemblerMatrixBase<HybridCoreBlockEntity> {

    public HybridCoreBlock(Properties props) {
        super(props);
    }

    @Override
    public Item getPresentItem() {
        return ModItems.ASSEMBLER_MATRIX_HYBRID_PLUS.get();
    }
