...
public class ModNetwork {
    ...
    public static void registerPayloadHandlers(final RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToServer(com.extendedae_plus.network.BatchPendingActionC2SPacket.TYPE,
                com.extendedae_plus.network.BatchPendingActionC2SPacket.STREAM_CODEC,
                com.extendedae_plus.network.BatchPendingActionC2SPacket::handle);
